...
//						"LIMIT ?,?";
				...
				for(int i=0;i<polist.size();i++) {
					...
					String sql02=" select oo.id,oo.orderno,oo.orderstatus,oo.paystatus,oo.ordertime,oo.paytime,oo.addrinfo,oo.mask\r\n" + 
							" FROM product p\r\n" + 
							" join product_orderinfo po\r\n" + 
							" join (select o.id,o.orderno,o.orderstatus,o.paystatus,o.ordertime,o.paytime,o.addrinfo,o.mask,ca.name,ca.addr,ca.phone,ca.provice,ca.city,ca.area,ca.addrd\r\n" + 
							"       from orderinfo o\r\n" + 
							"       join consumer_addr ca\r\n" + 
					...
					for(int j=0;j<oi.size();j++) {
						...
						String sql05="select ca.id id,ca.name cname,ca.addr addr,ca.phone phone,ca.provice province,ca.city city,ca.area area,ca.addrd addrs\r\n" + 
								"from orderinfo oi\r\n" + 
								"join consumer_addr ca\r\n" + 
